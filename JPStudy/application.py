...
subscription_key = '2C1CJ16zFsvke7AFR8hkt0uDms9kgU7X8WitgsBu3imyQhXzw5E4JQQJ99ALACHYHv6XJ3w3AAAAACOG62wl'
region = "eastus2"
language = "ja-JP"
voice = "Microsoft Server Speech Text to Speech Voice (ja-JP, AoiNeural)"
...
def gettonguetwister():
    business_phrases = [
        ...
        "只今、担当者が不在でございます。",
        "申し訳ございませんが、後ほど改めてご連絡させていただけますでしょうか。",
        "ご要望について、社内で検討させていただきます。",
        "ご不便をおかけし、大変申し訳ございません。",
        "ご指摘ありがとうございます。早速確認させていただきます。",
        "お世話になっております。○○株式会社の△△でございます。",
        "本日は、お時間をいただきまして、誠にありがとうございます。",
        "ご提案について、大変興味を持たせていただきました。",
        "その件につきまして、詳しくご説明させていただけますでしょうか。",
        "何かご不明な点がございましたら、お気軽にお申し付けください。"
    ]
    
    return jsonify({"tt":random.choice(business_phrases)})
